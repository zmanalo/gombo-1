 ...
 * [gombo.yml](gombo.yml)
     * Determines how your purl.obolibrary.org/obo/gombo/ redirects will be handled
     ...
     * Paste in the contents of [gombo.yml](gombo.yml)
 ...
 * [gombo.md](gombo.md)
     ...
     * Paste in the contents of [gombo.md](gombo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
